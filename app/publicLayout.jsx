    ...
    <Suspense fallback={<LogoLoading />}>
      {isReady ? (
        <div className="relative flex w-full h-full flex-col">
          <div className="fixed inset-0 mx-0 max-w-none overflow-hidden -z-10">
          ...
          <div className="pointer-events-none bg-white dark:bg-black fixed bottom-0 left-0 h-[10rem] [mask-image:linear-gradient(transparent,#000000)] w-full"></div>
        </div>
      ) : (
        <LogoLoading />
      )}
